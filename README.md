...
Fluence is sponsoring the [Upgrade the #BUIDLer's Toolbox](https://www.hack.lumoslabs.co/builders-toolbox) track with a USDC 3,500 and USDC 1,500 price for the best Web3 tooling, API, SDK, services, or patterns built with Fluence and Aqua. The easiest way to get started is to swing by the [developers docs](https://doc.fluence.dev/docs/) and then build a small Fluence project or try one of the [examples](https://github.com/fluencelabs/examples), identify tooling deficits and kick-off your hackathon project.
